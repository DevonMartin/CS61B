...
public class Tileset {
    private static final String path = System.getProperty("user.dir") + "/byow/src/";
    public static final TETile AVATAR = new TETile('@', Color.white, Color.black, "you", path + "avatar.png");
    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
            "wall", path + "wall.png");
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.black,
            "floor", path + "floor.png");
    public static final TETile NOTHING = new TETile(' ', Color.black, Color.black, "nothing");
    public static final TETile GRASS = new TETile('"', Color.green, Color.black, "grass", path + "grass.png");
